...
class Googlemaps {
	...
	var $apiKey						= 'AIzaSyAt1d4tNr01y-jxDhr17rVspLK-ENYFvpI'; 						// If you've got an API key you can use it by passing this parameter. Setup an API key here: https://code.google.com/apis/console
