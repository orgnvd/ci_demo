...
<?php } ?>
    ...
    <section class="content-header">
      <h1>
        <?php echo lang('import_state_csv');?>
      </h1>
	 </section>
        ...
        <div class="col-xs-12">
            <div class="box box-primary">
				...
				<ol class="breadcrumb bgnone">
					...
					<li class="active"><?php echo lang('import_state_csv');?></li>
	
					<a href="<?php echo base_url('public/front/csvFormat/state/csv_state.csv'); ?>" style="float:right;">
					<?php echo lang('download_csv');?>
					</a>
				</ol>
            </div>
            <!-- /.box-header -->
			<form method="post" name="business_category" id="b_category" action="<?php echo base_url('location/importState');?>" enctype="multipart/form-data">
				<div class="box-body">
					...
					<div class="form-group">
						...
						<div class="form-group">
							<label for="exampleInputFile"><?php echo lang('import_state');?></label>
