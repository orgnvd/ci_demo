...
<?php } ?>
    ...
    <section class="content">
      <div class="row">
        ...
        <li ><a href="<?php echo base_url('region');?>">Location</a></li>
        <li class="active"><?php echo lang('update_location');?></li>
      </ol>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form method="post" action="<?php echo base_url('region/editLocation/'.$fetchmodule['resultset']->country_id);?>" enctype="multipart/form-data" id="frm_subadmin">
              ...
              <div class="box-footer">
				...
				<a href="<?php echo base_url('region');?>" class="btn btn-danger">Cancel</a>
              </div>
			  <?php }else{
