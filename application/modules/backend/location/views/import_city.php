        ...
        <div class="col-xs-12">
            <div class="box box-primary">
				...
				<ol class="breadcrumb bgnone">
					...
					<li class="active"><?php echo lang('import_city_csv');?></li>
	
					<a href="<?php echo base_url('public/front/csvFormat/city/csv_city.csv'); ?>" style="float:right;">
					<?php echo lang('download_csv');?>
					</a>
				</ol>
            </div>
            <!-- /.box-header -->
			<form method="post" name="business_category" id="b_category" action="<?php echo base_url('location/importCity');?>" enctype="multipart/form-data">
				<div class="box-body">
