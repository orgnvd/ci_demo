...
<?php } ?>
    ...
    <section class="content">
      <div class="row">
		...
		<a href="<?php echo base_url('location/addLocation');?>">
					<button type="submit" class="btn btn-primary pull-right"><?php echo lang('add_location');?></button>
				</a>
		<a href="<?php echo base_url('location/countrycsv');?>">
					<button class="btn btn-primary pull-right"><?php echo lang('import_country');?></button>
				</a>
      </ol>
              ...
              <table id="example1" class="table table-bordered table-striped">
				...
				<?php if(!empty($module_list)){ 
					...
					<tr>
						...
						<td>
						<a class="btn btn-success" data-toggle="tooltip" data-placement="top" title="" href="<?php echo base_url() . "location/editLocation/" . $value->country_id; ?>" style="padding: 0px 4px;" data-original-title="Edit Location"><i class="fa fa-edit"></i></a>  
						<!--<a class="btn btn-danger" data-toggle="tooltip" data-placement="top" title="" href="<?php echo base_url() . "location/deleteLocation/" . $value->country_id; ?>" style="padding: 0px 4px;" data-original-title="Delete Location" onclick="return confirm('Are you sure? you want to delete.')"><i class="fa fa-trash"></i></a>--> 
  ...
  $(document).ready(function() {
        ...
        $(document).on('click', '.status_active', function() {
            ...
            if (r == true) {
                ...
                $.post('<?php echo base_url() ?>location/ajax_getlocationstatus', {'static_page_id': static_page_id, 'status': status}, function(data) {
