          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <ol class="breadcrumb bgnone">
				...
				<li ><a href="<?php echo base_url('contactforms/contact');?>"><?php echo 'Contact Queries';?></a></li>
			...
			<input type="hidden" name="idddd" value="<?php echo @$userinfo[0]['id'];?>">
              ...
              <div class="box-footer">
				<a href="<?php echo base_url('contactforms/contact');?>" class="btn btn-danger">Cancel</a>
              </div>
            </form>
          </div>
          <!-- /.box -->
