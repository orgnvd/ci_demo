				  ...
				  <table id="example1" class="table table-bordered table-striped">
					...
					?>
						...
						<tr>
							...
							<td>
							<a class="btn btn-success" data-toggle="tooltip" data-placement="top" title="" href="<?php echo base_url() . "contactforms/edit/" . $value['id']; ?>" style="padding: 0px 4px;" data-original-title="View Contact"><i class="fa fa-edit"></i></a>  
							<a class="btn btn-danger" data-toggle="tooltip" data-placement="top" title="" href="<?php echo base_url() . "contactforms/deletetemessage/" . $value['id']; ?>" style="padding: 0px 4px;" data-original-title="Delete Cms" onclick="return confirm('Are you sure? you want to delete.')"><i class="fa fa-trash"></i></a> 
